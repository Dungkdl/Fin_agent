...
class LightGBMQuantModel(BaseQuantModel):
    ...
    def cross_val_predict(self, df_train: pd.DataFrame, cv_splitter) -> np.ndarray:
        logger.info("Sinh Walk-Forward Out-Of-Fold probabilities cho LightGBM...")
        # Sử dụng đúng self.features thay vì trích xuất lại
        # Đảm bảo ép kiểu object sang category
